            ...
            <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white">
                ...
                <div className="flex flex-col flex-1 px-3 mt-6">
                    <div className="space-y-4">
                        ...
                        <nav className="flex-1 space-y-2">
                            <a href="#" className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 text-gray-900 hover:text-white rounded-lg hover:bg-indigo-600 group">
                                <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" classNameName="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                </svg>
                                    <path
